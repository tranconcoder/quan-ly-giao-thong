...
def sync_images_and_labels(directory_path):
    ...
    và xóa các file trong thư mục images nếu không có file trùng tên trong thư mục labels.
    ...
    # Duyệt qua các file trong images
    for image_file in os.listdir(images_dir):
        image_name, _ = os.path.splitext(image_file)
        if image_name not in label_files:
            # Xóa file nếu không có tên trùng trong thư mục labels
